...
static ZH: Strings = Strings {
    ...
    llm_section: "格式化输出配置",
    llm_service_title: "格式化输出服务",
    llm_service_desc: "配置模型、接口地址和系统提示词，用于转录后的格式化输出。",
    llm_enable: "启用格式化输出",
    llm_api_url: "接口地址",
...
Return ONLY the processed text. No explanations."#,
    ...
    wordbook_desc: "维护常用术语，让转录结果更符合你的日常输入习惯。",
    wordbook_word: "词条",
    wordbook_add: "添加",
    wordbook_delete: "删除",
    about_section: "关于软件",
...
static ZH_TW: Strings = Strings {
    ...
    hotkey_mode_toggle_short: "切換",
    hotkey_mode_ptt_short: "按住說話",
    ...
    llm_section: "格式化輸出設定",
    llm_service_title: "格式化輸出服務",
    llm_service_desc: "設定模型、介面地址和系統提示詞，用於轉錄後的格式化輸出。",
    llm_enable: "啟用格式化輸出",
    llm_api_url: "介面地址",
...
Return ONLY the processed text. No explanations."#,
    ...
    wordbook_desc: "維護常用術語，讓轉錄結果更符合你的日常輸入習慣。",
    wordbook_word: "詞條",
    wordbook_add: "新增",
    wordbook_delete: "刪除",
    about_section: "關於軟體",
...
static EN: Strings = Strings {
    ...
    llm_section: "Format Output Configuration",
    llm_service_title: "Format Output Service",
    llm_service_desc: "Configure model, API URL and system prompt for post-transcription formatting output.",
    ...
    llm_model: "Model",
    llm_model_desc: "Model for formatting output",
...
Return ONLY the processed text. No explanations."#,
    ...
    wordbook_desc: "Maintain custom terms to match your input habits.",
    wordbook_word: "Word",
    wordbook_add: "Add",
...
pub fn get(lang: UiLanguage) -> &'static Strings {
    match lang {
        ...
        // Japanese UI strings are fully implemented in the React frontend. The
        // Tauri side (tray / overlay) falls back to English for now.
