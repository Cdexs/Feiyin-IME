...
**出包**：2026-08-03 13:06（BUILD-010，含 017+018）／17:07（BUILD-011，含 021+020）／**17:42（BUILD-012，含 023，当前 Publish 产物）**。三 exe 两副本 sha256 一致 + 两 toml 三副本一致（`scene-rules.toml` `7C1F0620`／`itn-rules.toml` `ED77A912`）+ ProductVersion 0.7.3.0 + mtime 链通过。**详见 CHANGELOG，出包/测试同步不在本文档记录（规则 7）**
