...
> 当前版本：**v0.7.2**（三处版本号均 0.7.2，2026-07-30 主控复核）
> ⚠️ **现存产物已过期**：`feiyin-ime.exe` 停留 07-28 18:42、`feiyin-ime-ui.exe` 停留 07-27 20:31，而最新源码改动为 07-30 00:57 → **当前 exe 不含 MACOS-COMPAT-001 与 FIX-COT-LEAK-001-P0 两批次**，出包被 Gavin 明确叫停（「先不出包，等我指令！」）
